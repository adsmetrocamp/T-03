      ...
      <form onSubmit={loginForm.handleSubmit}>
        ...
        <Box mt={8}>
          <FormControl isInvalid={!!loginForm.errors.email}>
            ...
            <Input placeholder="Digite seu email" name="email" onChange={loginForm.handleChange} maxLength={255} />
          ...
          <FormControl mt={4} isInvalid={!!loginForm.errors.password}>
            ...
            <Input placeholder="Digite sua senha" type="password" name="password" onChange={loginForm.handleChange} maxLength={255} />
          ...
          <Box display="flex" justifyContent="space-between" alignItems="center" mt={4}>
            <Checkbox colorScheme="purple.500" onChange={() => loginForm.setFieldValue("shouldRemember", !loginForm.values.shouldRemember)} isChecked={true}>
              Lembrar-se de mim
            </Checkbox>
