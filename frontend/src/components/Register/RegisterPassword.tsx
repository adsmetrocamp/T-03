    ...
    <Box width="70%">
      <form onSubmit={registerPasswordForm.handleSubmit}>
        ...
        <Box mt={8}>
          ...
          <FormControl mt={4} isInvalid={!!registerPasswordForm.errors.password}>
          ...
          <FormControl mt={4} isInvalid={!!registerPasswordForm.errors.passwordConfirmation}>
            ...
            <Input
              ...
              onChange={registerPasswordForm.handleChange}
              value={registerPasswordForm.values.passwordConfirmation}
              maxLength={255}
            />
